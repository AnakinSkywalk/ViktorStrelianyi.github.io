$(document).ready(function() {
	...
	// services slide out/ slide in animation
	$(".s_item ul").each(function(){
		$(this).after("<div class='s_item_after'></div>");
	});
	$(".item_toggle").click(function(){
		if($(this).parent().children("ul").is(":visible")) {
			$(this).parent().children("ul").slideUp();
			$(this).parent().children(".s_item_after").slideUp();
		}
		else {
			$(".s_item_after,.s_item ul").hide();
			$(".s_item").removeClass('active');
			$(this).parent().addClass('active');
			$(this).parent().children("ul").slideDown();
			$(this).parent().children(".s_item_after").slideDown();
		}
	});	
	...
	var eqElement = ".home_item, .article_content>div"
